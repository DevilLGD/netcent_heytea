...
import 'package:heytea_kit/widget/transformer_page_view/index_controller.dart';
export 'package:heytea_kit/widget/transformer_page_view/index_controller.dart';
export 'package:heytea_kit/widget/transformer_page_view/parallax.dart';
...
class _TransformerPageViewState extends State<TransformerPageView> {
  ...
  Widget _buildItemNormal(BuildContext context, int index) {
    int renderIndex = _pageController?.getRenderIndexFromRealIndex(index) ?? 0;
