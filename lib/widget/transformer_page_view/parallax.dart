...
import 'package:heytea_kit/widget/transformer_page_view/transformer_page_view.dart';
...
class ParallaxImage extends StatelessWidget {
  ...
  ParallaxImage.asset(String name, {double position: 0, this.imageFactor: 0.3})
